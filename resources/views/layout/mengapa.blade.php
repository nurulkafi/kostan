<div class="container isi">
    <h1 class="mt-5 text-center">Mengapa Kosan.id ?</h1>
    <div class="container" style="width: 50%">
        <h4 class="mengapa text-center px-5">
            Kosan.id  menjadi pilihan untuk mencari kos paling <b>praktis, simple dan mudah</b> karena : 
        </h4>
    </div>
